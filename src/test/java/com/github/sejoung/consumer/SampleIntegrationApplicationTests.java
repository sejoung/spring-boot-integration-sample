package com.github.sejoung.consumer;

import static org.assertj.core.api.Assertions.assertThat;

import com.github.sejoung.Application;
import com.github.sejoung.producer.ProducerApplication;
import java.io.File;
...
public class SampleIntegrationApplicationTests {
	...
	public void testMessageGateway() throws Exception {
		this.context = SpringApplication.run(Application.class, "testviamg");
		String output = getOutput();
